...
- <b>/AbsVel<b> contains the weighted mean absorption velocities, based on Fe II 5169, of SNe Ic, Ic-bl and SLSNe Ic as shown in [Liu, Modjaz & Bianco (2017)](http://adsabs.harvard.edu/abs/2016arXiv161207321L). Those velocities are somewhat different from those computed in [Liu et al. (2016)](http://adsabs.harvard.edu/abs/2016ApJ...827...90L) and [Modjaz et al. (2016)](http://adsabs.harvard.edu/abs/2016ApJ...832..108M), but supersede them.
